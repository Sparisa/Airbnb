...
In conclusion, I would like to say that if we put aside the lack of accessible data, getting 61% accuracy for RF model, 60% for DT and 59% for KNN is a success. These models would work out in a better accuracy if the sufficient amount of data become avalable to public and there is a great space to improve it. 


```

![Matrix of confusion](./images/matrixofconf.png)
```
